  ...
  Widget build(BuildContext context) {
    return SafeArea(
       ...
       Row(
             children: [
               Padding(
                 ...
                 child: Image.asset('assets/images/getting_start.png'),
               ),
             ],
           ),
           Row(
             children: [
               Padding(
                 ...
                 child: Image.asset('assets/images/getting_startdata.png'),
               ),
             ],
           ),
      ...
      Padding(
        ...
        child:   Image.asset('assets/images/check_box.png'),
      ),
      Image.asset('assets/images/check_boxdata.png'),
      ...
      Padding(
         ...
         child: Image.asset('assets/images/already_have.png'),
       ),
      ...
      Padding(
        ...
        Padding(
          ...
          child:  const Text('Connect With Facebook', style: TextStyle(color: Colors.white),),
